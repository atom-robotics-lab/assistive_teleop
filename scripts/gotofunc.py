...
class Robot_Controller:
    ...
    def __init__(self):
        ...
        self.P = rospy.get_param("Obstacle_avoider/pid/p") #1.7
        self.I = rospy.get_param("Obstacle_avoider/pid/i")
        ...
        self.theta_derivative = rospy.get_param("Obstacle_avoider/theta_derivative")
        self.theta_integral = rospy.get_param("Obstacle_avoider/theta_integral") 
